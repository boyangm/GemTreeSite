...
const MusicPage = () => {
    ...
    const [music, setMusic] = useState("https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/users/26074327&color=%23b8a5b4&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true")
    const DSP = (title) => {
    ...
    return (
        <div className='musicPage'>
            <div id="music" className="widgetArea" >
                ...
                <iframe onClick={() => DSP()} className='mediaPlayer' src={music} width="250" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
